	 ...
	 <a href=""> <img
		...
		<div class="collapse navbar-collapse" id="navbarTogglerDemo03">
			...
			<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
				<li class="nav-item active"><a class="nav-link text-orange "
					style="font-size: 20px;" href="<c:url value="/Welcome"></c:url>"><i
						class="fas fa-home" style="color: orange;"></i></a></li>
				<c:if test="${not empty sessionScope.user}">
					<li class="nav-item text-orange"><a
						class="nav-link text-orange " style="font-size: 14px;"
						href="<c:url value="/ctl/User/AddUser"/>"><i
							class="fas fa-user" style="color: orange;"></i> <span
							style="color: orange;"><b><s:message code="label.adduser" /></b></span></a>

					</li>

					<li class="nav-item text-nowrap"><a class="nav-link text-light "
						style="font-size: 14px;"
						href="<c:url value="/ctl/Student/AddStudent"/>"><i
							class="fa fa-user-circle" style="color: orange;"></i> <span
							style="color: orange;"><b><s:message
										code="label.addstudent" /></b> </span></a></li>
					...
					<li class="nav-item text-nowrap"><a
						...
						href="<c:url value="/ctl/College/AddCollege"/>"><i
							...
							style="color: orange;"><b><s:message code="label.addcollege" /></b></span></a>
					</li>
					...
					<li class="nav-item text-nowrap"><a
						...
						href="<c:url value="/ctl/Faculty/AddFaculty"/>"><i
							...
							style="color: orange;"><b><s:message code="label.addfaculty" /></b></span></a>
					</li>
					...
					<li class="nav-item text-nowrap"><a
						...
						href="<c:url value="/ctl/Subject/AddSubject"/>"><i
							...
							style="color: orange;"><b><s:message code="label.addsubject" /></b></span></a>
					</li>
					...
					<li class="nav-item text-nowrap"><a
						...
						href="<c:url value="/ctl/Role/AddRole"/>"><i
							...
							style="color: orange;"><b><s:message code="label.addrole" /></b></span></a>
					</li>
					...
					<li class="nav-item text-nowrap"><a
						...
						href="<c:url value="/ctl/Course/AddCourse"/>"><i
							...
							style="color: orange;"><b><s:message code="label.addcourse" /></b></span></a>
					</li>
					...
					<li class="nav-item dropdown text-nowrap"><a
						class="nav-link dropdown-toggle text-light" data-toggle="dropdown" href=""
						role="button" aria-haspopup="true" aria-expanded="false"> <span><i
								class="fa fa-address-book"
								style="color: orange; font-size: 14px;"></i></span>&nbsp;<span
							style="color: orange; font-size: 14px;"><b><s:message
									code="label.marksheet" /></b></span></a>

						<div class="dropdown-menu dropdown-menu-right" style="background-color: rgba(0,0,0,0.48);">

							<a class="dropdown-item"
								href="<c:url value="/ctl/Marksheet/AddMarksheet"/>"><i
								class="fa fa-arrow-circle-right" style="color: orange; aria-hidden="true"></i> <span
								style="color: orange;"><b><s:message
								...
								class='fa fa-user-circle' style="color: orange;"></i><span
								style="color: orange;"> <span style="color: orange;"><b><s:message
		...
		<div class="navbar nav-item dropdown text-nowrap dropdown-menu-left">
			...
			<div class="dropdown-menu dropdown-menu-right" style="font-size: 15px; background-color: rgba(0,0,0,0.48)">
				...
				<c:if test="${not empty sessionScope.user}">
					...
					<a class="dropdown-item"
						...
						class="fa fa-random" aria-hidden="true" style="color: orange;"></i>

						<span style="color: orange;"><span style="color: orange;"><b><s:message
									code="label.changepassword" /></b></span> </span></a>

					<a class="dropdown-item"
						 target="blank" href="<c:url value="./resources/javadoc/index.html"/>"><i
						class='fas fa-caret-square-right' style="color: orange;"></i> <span
						style="color: orange;"><span style="color: orange;"><b><s:message
...
<c:url  value="${logoutUrl}"/> --%>
					<a class="dropdown-item" href="<c:url value="/Login">
						...
						class='fas fa-caret-square-left' style="color: orange;"></i> <span
						style="color: orange;"><span style="color: orange;"><b><s:message
				...
				<c:if test="${empty sessionScope.user}">
					...
					<a class="dropdown-item" href="<c:url value="/Login"></c:url>"><i
						class="fa fa-arrow-circle-right" style="color: orange;" aria-hidden="true"></i> <span
						style="color: orange;"><b><s:message code="label.login" /></b></span></a>

					<a class="dropdown-item"
						href="<c:url value="/Registration"></c:url>"><i
						class="fa fa-arrow-circle-right" style="color: orange;" aria-hidden="true"></i> <span
						style="color: orange;"><b><s:message code="label.signup" /></b></span></a>
